local options = {
	...
	foldlevel = 99, -- prevent from folding by default
	foldlevelstart = 99,
	foldcolumn = "1",
	fillchars = {
		-- configures fold symbols
		eob = " ",
		fold = " ",
		foldopen = require("config.symbols").arrow_open,
		foldsep = " ",
		foldclose = require("config.symbols").arrow_closed,
	},
	list = true,
	listchars = {
		-- replace certain invisible characters with symbols
		tab = "→ ",
		trail = "·",
		extends = "…",
		precedes = "…",
